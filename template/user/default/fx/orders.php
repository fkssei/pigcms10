...
<html>
	<head>
		<meta charset="utf-8"/> 
		<title>采购清单 - <?php echo $config['site_name'];?>分销平台 | <?php if (empty($_SESSION['sync_store'])) { ?><?php echo $config['site_name'];?><?php } else { ?>微店系统<?php } ?></title>
		...
		<script type="text/javascript">var load_url="<?php dourl('load');?>", pay_url = "<?php dourl('orders'); ?>";</script>

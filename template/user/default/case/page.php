...
<html>
	<head>
		...
		<script type="text/javascript">var load_url="<?php dourl('case_load');?>", create_page_url="<?php dourl('create_page'); ?>", del_page_url="<?php dourl('delete_page'); ?>", rename_page_url="<?php dourl('rename_page'); ?>";</script>

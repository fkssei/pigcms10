...
<head>
    ...
    <title>切换店铺 - <?php echo $store['name'];?></title>
...
<div class="panel member-nav">
    <ul class="side-nav">
        ...
        <li <?php if ($key == (count($store_info) - 1)) { ?>class="last"<?php } ?>><a href="./drp_store.php?a=select&id=<?php echo $store_info['store_id']; ?>"><i class="icon-shop"></i><span class="text"><?php echo $store_info['name']; ?></span><i class="arrow"></i></a></li>
        <?php } ?>
    </ul>
</div>
<?php } ?>

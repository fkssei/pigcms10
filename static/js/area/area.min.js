...
var __alldiv = {
	...
	659003:['图木舒克市','659000'],
	659004:['五家渠市','659000']}
function getProvinces(spid,vp,dv) {
	var sp = document.getElementById(spid);
	var length = 0;
	sp.options.length = 0;
	sp.options.add(new Option((dv ? dv : "选择省份"), ""));
...
function getCitys(scid, spid,vc,dv) {
	...
	sc.options.add(new Option((dv ? dv : "选择城市"), ""));
	for (var key in __alldiv){
...
function getAreas(said, scid,va,dv) {
	...
	sa.options.add(new Option((dv ? dv : "选择地区"), ""));
	for (var key in __alldiv){
